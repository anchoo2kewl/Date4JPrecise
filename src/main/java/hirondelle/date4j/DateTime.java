...
public final class DateTime implements Comparable<DateTime>, Serializable {
  ...
  public DateTime(Integer aYear2, Integer aMonth2, Integer aDay2, Integer aHour2,Integer aMinute2, Integer aSecond2, long aNanosecond2, int flag) 
  {
	  	fIsAlreadyParsed = true;
	    fYear = aYear2;
	    fMonth = aMonth2;
	    ...
	    fMinute = aMinute2;
	    fSecond = aSecond2;
	    longFNanosecond = aNanosecond2;
	    fNanosecond = (int) aNanosecond2;
	    validateState();	    
}
...
/**
  ...
  public static DateTime forInstant(long aMilliseconds, TimeZone aTimeZone) {
    	...
    	try {
			...
			BufferedReader bri = new BufferedReader
		            ...
		            while ((line = bri.readLine()) != null) {
		              ...
		              nanoseconds = Integer.parseInt(line);
		            }
		            bri.close();
    ...
    //System.out.println(new DateTime(year, month, day, hour, minute, second, nanoseconds));
    //System.out.println("Milli Seconds Calculated by getCurrentMilli -> "+milliseconds);
  ...
  */
  ...
  public long getNanosecondsNano() {
	    ensureParsed();
	    return longFNanosecond;
	  }
  
  public String testNano() {
	    return "test123";
	  }
  ...
  */
  ...
  public DateTime minusPrecise(Integer aNumYears, Integer aNumMonths, Integer aNumDays, Integer aNumHours, Integer aNumMinutes, Integer aNumSeconds, Integer aNumNanoseconds, DayOverflow aDayOverflow) {
	    DateTimeInterval interval = new DateTimeInterval(this, aDayOverflow);
	    return interval.minusPrecise(aNumYears, aNumMonths, aNumDays, aNumHours, aNumMinutes, aNumSeconds, aNumNanoseconds);
	  }
  
  public DateTime minusPreciseNano(Integer aNumYears, Integer aNumMonths, Integer aNumDays, Integer aNumHours, Integer aNumMinutes, Integer aNumSeconds, Integer aNumNanoseconds, DayOverflow aDayOverflow) {
	    DateTimeInterval interval = new DateTimeInterval(this, aDayOverflow,0);
	    return interval.minusPreciseNano(aNumYears, aNumMonths, aNumDays, aNumHours, aNumMinutes, aNumSeconds, aNumNanoseconds);
	  }
  
  public DateTime plusPreciseNano(Integer aNumYears, Integer aNumMonths, Integer aNumDays, Integer aNumHours, Integer aNumMinutes, Integer aNumSeconds, Integer aNumNanoseconds, DayOverflow aDayOverflow) {
	    DateTimeInterval interval = new DateTimeInterval(this, aDayOverflow,0);
	    return interval.plusPreciseNano(aNumYears, aNumMonths, aNumDays, aNumHours, aNumMinutes, aNumSeconds, aNumNanoseconds);
	  }
...
DateTime newDt = oldDt.changeTimeZone(fromUK, toIndonesia);
  ...
  */
  @Override public String toString() {
    ...
    return result;
 	...
 	public DateTime toStringNano() 
 	{
 			return new DateTime(fYear,fMonth,fDay,fHour,fMinute,fSecond,(int)longFNanosecond);
  }

  public String toStringMilli() 
  {
	  DecimalFormat df=new DecimalFormat("0.000");
	  Double nano = (1000000000+(double)(this.getNanosecondsNano()))/1000000000-1;
  ...
  */
  ...
  {
	  //System.out.println("DateTime.dbdis - Enter");
	  int [] datediff = difference(d1, d2);
	  //System.out.println("DateTime.dbdis - Exit");
  ...
  public static int [] difference(DateTime d1, DateTime d2){
	    ...
	    fDay = d1.getDay();
	    fHour = d1.getHour();
	    fMinute = d1.getMinute();
	    fSecond = d1.getSecond();
	    fNanosecond = d1.getNanoseconds();*/
	    ...
	    d1array[6] = (int)d1.getNanoseconds();
	    ...
	    d2array[6] = (int)d2.getNanoseconds();
